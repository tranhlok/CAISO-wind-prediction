...
### Goal 2: Wind Power Prediction
Predict actual power generation by wind plants of SP15 hub on 2024-04-09.

1. Train a model using actual, forecast data, or both.
2. Choose an appropriate model for the prediction task.
3. Include necessary steps such as visualization, data preprocessing, and model tuning.
4. Specify and justify the model choice in your code.
